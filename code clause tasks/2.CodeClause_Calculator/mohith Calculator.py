...
buttonaequal = Button(root,text="=",padx=40,pady=20,command=equal)
buttonclear = Button(root,text="clear",padx=30,pady=10,command=clear)
buttonpow = Button(root,text="pow",padx=30,pady=10,command=pow)
buttonquit = Button(root,text="exit",padx=30,pady=10,command=root.quit)
...
buttonaequal.grid(row=5,column=2)
